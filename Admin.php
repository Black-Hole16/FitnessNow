...
<body>
  ...
  <ul class="menu">
    ...
    <li><a href="Usuario/Delete.php"><img src="assets/img/delete-user.png" alt="proveedor"><figcaption> Eliminar Usuario</figcaption></a></li>
    ...
    <li><a href="Usuario/edit.php"><img src="assets/img/editar-usuaria.png" alt="proveedor"><figcaption>Editar Usuario</figcaption></a></li>
