...
include("../conec.php");
        ...
        if($DB->num_rows($consulta)>0){
            ...
            echo "
            <th width='149'>Identificación De Cliente</th>
            <th width='211'>Nombre De Cliente</th>
            <th width='211'>Dirección De Cliente</th>
            <th width='211'>Telefono De Cliente</th>
            <th width='211'> enero De Cliente</th>
            <th width='211'>Fecha De Inreso Cliente</th>
            <th width='211'>Fecha De Nacimiento Cliente</th>
