...
include("../conec.php");
        ...
        if($DB->num_rows($consulta)>0){
            ...
            echo "
            <th width='149'>Identificación De Empleado</th>
            <th width='211'>Nombre De Empleado</th>
            <th width='211'>Dirección De Empleado</th>
            <th width='211'>Telefono De Empleado</th>
            <th width='211'>Fecha De Empleado</th>
            </tr>
            ";
